	...
	public class BoxBoxCollisionAlgorithm : ActivatingCollisionAlgorithm
	{
		public class CreateFunc : CollisionAlgorithmCreateFunc
		{
			...
			public CreateFunc()
				: base(ConstructionInfo.Null)
			{
				var native = btBoxBoxCollisionAlgorithm_CreateFunc_new();
		...
		{
			var native = btBoxBoxCollisionAlgorithm_new(ci.Native);
			InitializeUserOwned(native);
		}
		...
		public BoxBoxCollisionAlgorithm(PersistentManifold mf, CollisionAlgorithmConstructionInfo ci,
			CollisionObjectWrapper body0Wrap, CollisionObjectWrapper body1Wrap)
		{
			var native = btBoxBoxCollisionAlgorithm_new2(mf.Native, ci.Native, body0Wrap.Native,
				body1Wrap.Native);
			InitializeUserOwned(native);
		}
	}
